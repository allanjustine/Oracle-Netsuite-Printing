...
const SMCTAntipolo = ({ data }: any) => {
  ...
  return (
    <div className="text-xs w-[801.25984252px] h-[408.18897638px] ml-[25px]">
      ...
      <div className="w-[718.11023622px] pl-[551.92913386px] mt-[27.7952755906px]">
        <p>
