...
const HO_SMCT = ({ data }: any) => {
  ...
  return (
    <div className="text-xs w-[755.90551181px] h-[404.03149606px] ml-[5px]">
      <div className="flex mt-[116.50393701px]">
        <p className="ml-[590.82677165px] w-[147.4015748px]">
          {data[1]?.[CR_Date] || <span className="opacity-0">No data</span>}
        </p>
      </div>
      <div className="flex w-[755.90551181px] mt-[21.7952755906px]">
