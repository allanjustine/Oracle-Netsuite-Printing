...
const LapuLapu = ({ data }: any) => {
  ...
  return (
    <div className="text-xs w-[790.2992126px] h-[404.03149606px] pl-[21px]">
      <div className="flex mt-[100.488188976px]">
        <p className="ml-[585.82677165px] w-[147.4015748px]">
          {data[1]?.[CR_Date] || <span className="opacity-0">No data</span>}
        </p>
      </div>
      <div className="flex w-[790.2992126px] mt-[26.7952755906px]">
      ...
      <div className="flex ml-[302.36220472px] mt-[7.8267716539px]">
        <p className="w-[362.83464567px] text-[11px]">
          {data[1]?.[CR_Address] || <span className="opacity-0">No data</span>}
        </p>
      </div>
      <div className="flex mt-[4.8267716539px] w-[790.2992126px]">
      ...
      <div className="flex w-full mt-[4.8267716539px]">
      ...
      <div className="ml-[226.77165354px] mt-[2.1811023622]">
        <p>
