...
const DSMButuan = ({ data }: any) => {
  ...
  return (
    <div className="text-xs h-[400.62992126px] w-[767.24409449px]">
      <div className="w-[117.16535433px] flex items-center mt-[102.9291338579px] ml-[604.72440945px] h-[21.921259843px]">
