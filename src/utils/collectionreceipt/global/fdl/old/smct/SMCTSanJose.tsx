...
const SMCTSanJose: React.FC<PrintPageProps> = ({ data }) => {
  const CR_Date = 0;
  const CR_Name = 1;
  const CR_TIN = 2;
  const CR_Address = 3;
  ...
  return (
    <div className="text-xs w-[805.03937008px] h-[415.7480315px] ml-[10px]">
      ...
      <div className="w-[782.36220472px] mt-[9.8267716539px]">
      ...
      <div className="w-[782.36220472px] pl-[566.92913386px] mt-[40.7952755906px] text-[11px]">
