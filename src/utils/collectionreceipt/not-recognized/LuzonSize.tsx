    ...
    <div className="text-xs w-[577.88976378px] h-[381.73228346px] mt-[27.590551181px]">
      ...
      <div className="flex justify-between mt-[14.7952755906px]">
        <div className="w-[442.20472441px]">
          <p className={`ml-[264.56692913px] ${enyeFormat(data[1]?.[CR_Name]).length > 20 ? 'text-[10px]' : ''}`}>
      ...
      <div className="w-[577.88976378px] pl-[445.98425197px] mt-[10.7952755906px] text-[11px]">
        <p>
