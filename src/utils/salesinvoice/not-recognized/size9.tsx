...
const Size9Sales: React.FC<PrintPageProps> = ({ data }) => {
  ...
  return (
    <div className="text-xs h-[718.11px] w-[566.929px]">
      ...
      <div className="mx-[30.23px] mt-[25px] h-[215.43px]">
