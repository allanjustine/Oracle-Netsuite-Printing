...
const DSMCatar2 = ({ data }: any) => {
  ...
  return (
    <div className="text-xs h-[767.24409449px] w-[610.39370079px]">
      <div className="flex items-center h-[29.480314961px] mx-[37.795275591px] ml-[412.34645669px] mt-[166.999999996px]">
      ...
      <div className="mx-[37.795275591px] h-[132.28346457px] mt-[10px]">
