...
const DSMNorzagaray = ({ data }: any) => {
  ...
  return (
    <div className="text-xs h-[763.46456693px] w-[610.39370079px]">
      <div className="w-full h-[30.236220472px] mt-[160.18110236px]">
        <p className="w-[160.62992126px] pl-[415.7480315px]">
          {data[1]?.[date] || ""}
        </p>
      </div>
      ...
      <div className="mx-[34.015748031px] mt-[35.236220472px] h-[230.5511811px]">
