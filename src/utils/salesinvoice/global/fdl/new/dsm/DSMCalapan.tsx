...
const DSMCalapan = ({ data }: any) => {
  ...
  return (
    <div className="text-xs h-[767.24409449px] w-[610.39370079px]">
      <div className="flex items-center h-[29.480314961px] mx-[37.795275591px] ml-[425.34645669px] mt-[144.1023622px]">
