...
const DAPSucabon = ({ data }: any) => {
  ...
  return (
    <div className="text-xs h-[767.24409449px] w-[610.39370079px]">
      <div className="flex items-center h-[29.480314961px] mx-[37.795275591px] ml-[412.34645669px] mt-[150.999999996px]">
      ...
      <div className="mt-[17.007874016px] mx-[37.795275591px] h-[73.700787402px] w-[534.80314961px]">
        <p className="w-[389.29133858px] flex items-center h-[24.566929134px] ml-[160.96062992px]">
          {data[1]?.[mainLineName]
            ?.replace(/Ã/g, "Ñ")
            .replace(/Ã‘/g, "Ñ")
        ...
        <p
          ...
          } w-[389.29133858px] flex items-center h-[24.566929134px] ml-[160.96062992px]`}
        >
      ...
      <div className="w-[610.39370079px]">
        <div className="mt-[15.897637795px] ml-[192.75590551px] w-[160.96062992px]">
