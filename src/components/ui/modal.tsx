    ...
    <>
      <div className="fixed z-50 inset-0 overflow-y-auto">
        <div className="grid items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle md:w-10/12 w-full">
            <button
              type="button"
              onClick={onClose}
            ...
            <div className="bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden w-full">
              <div className="px-5 pt-2">
                ...
                <p>
                    <span className="font-bold text-red-500">Take Note: </span> <span className="font-bold text-gray-600">This is only a preview of the data not a real print.</span>
                </p>
              </div>
